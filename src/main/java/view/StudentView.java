...
public class StudentView extends VBox {
    ...
    public StudentView(Stage primaryStage, String username, QuestionController questionController,UserController userController) {
        ...
        answerQuestionsButton.setOnAction(e -> {
            primaryStage.setScene(new Scene(new view.AnswerQuestionsView(primaryStage, username,examController,userController), 900, 600));
        });
        ...
        logoutButton.setOnAction(e -> {
            ...
            primaryStage.setScene(new Scene(new view.LoginView(primaryStage, userController,questionController), 900, 600));
        });
